...
[`@aws-sdk/client-oam`](https://www.npmjs.com/package/@aws-sdk/client-oam/v/3.1015.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-oam@3.1015.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2NjtVSzDzaAlVUvrOsQ9SV0+sQ4gTZFM3UssAir/ed4moTgRZo08eFGo89FfaiEL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-oam": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-oam@3.1015.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-oam@3.1015.0/index.min.mjs": "sha384-2NjtVSzDzaAlVUvrOsQ9SV0+sQ4gTZFM3UssAir/ed4moTgRZo08eFGo89FfaiEL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-oam/blob/refs/tags/3.1015.0/LICENSE
```
