...
[`@aws-sdk/client-oam`](https://www.npmjs.com/package/@aws-sdk/client-oam/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-oam@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-np3XIhryqdF6J+mv2lpSXg4532LZHRP2mtWW0JjutttoUN21bgBSWvpr1HWdBlYG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-oam": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-oam@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-oam@3.276.0/index.min.mjs": "sha384-np3XIhryqdF6J+mv2lpSXg4532LZHRP2mtWW0JjutttoUN21bgBSWvpr1HWdBlYG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-oam/blob/refs/tags/3.276.0/LICENSE
```
